...
problem)
- 10/9/2012: updated for next round (removed eDes, etc.)
    - also save parameter string to MOOS
...
% n is number of MPC states - 1 (EXCLUDING ePSI)
...
% log some parameters
logStr = sprintf('N,%d,T,%d,mu,%0.2f,X0,%f,Y0,%f,PHI0,%f,PHI_DES,%f,hspeed,%f,P_LOSS,%f',...
    N,T,mu,x0,y0,h0,bearing,hspeed,probPLoss);
