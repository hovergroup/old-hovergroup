...
for i = 1:(N-1)
    ...
    % THIS VERSION ALWAYS DOES REGULATION
    
    if(uDelay)
        [uPlanNext tMPC] = solveKayakMPC(sys,xMPC,MPCparams,uDelay,uPlan(:,1),xDes);
    else
        [uPlan tMPC] = solveKayakMPC(sys,xMPC,MPCparams,uDelay,u,xDes);
    end
    uPlan
