...
SOFT_CONFIG["NOSTROMO:POSITIVE_X"]=192.2571745
SOFT_CONFIG["NOSTROMO:POSITIVE_Y"]=5.556153848
SOFT_CONFIG["NOSTROMO:NEGATIVE_X"]=-132.2571745
SOFT_CONFIG["NOSTROMO:NEGATIVE_Y"]=-125.5561538
SOFT_CONFIG["NOSTROMO:INITIAL_X"]=30
SOFT_CONFIG["NOSTROMO:INITIAL_Y"]=-60

SOFT_CONFIG["SILVANA:POSITIVE_X"]=202.2571745
SOFT_CONFIG["SILVANA:POSITIVE_Y"]=-14.44384615
SOFT_CONFIG["SILVANA:NEGATIVE_X"]=-122.2571745
SOFT_CONFIG["SILVANA:NEGATIVE_Y"]=-145.5561538
SOFT_CONFIG["SILVANA:INITIAL_X"]=40
SOFT_CONFIG["SILVANA:INITIAL_Y"]=-80

SOFT_CONFIG["KESTREL:POSITIVE_X"]=212.2571745
SOFT_CONFIG["KESTREL:POSITIVE_Y"]=-34.44384615
SOFT_CONFIG["KESTREL:NEGATIVE_X"]=-112.2571745
SOFT_CONFIG["KESTREL:NEGATIVE_Y"]=-165.5561538
SOFT_CONFIG["KESTREL:INITIAL_X"]=50
SOFT_CONFIG["KESTREL:INITIAL_Y"]=-100
#-------------------------------------------------------
...
if $SIMULATION ; then
    ...
    if [ "${VNAME}" = "ICARUS" ] ; then
        ...
        nsplug meta_vehicle_fld_rtk.moos targ_$VNAME.moos -f       \
            ...
            INITIAL_X=${SOFT_CONFIG["${VNAME}:INITIAL_X"]} \
            INITIAL_Y=${SOFT_CONFIG["${VNAME}:INITIAL_Y"]}
