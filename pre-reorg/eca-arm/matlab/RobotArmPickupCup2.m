...
command2 =uint8(hex2dec(['E7';'FF';'FF';'00';'00';'00';'00';'00';'0F';'FF';'00';'32';'00';'00';'01';'7F';'FF';'0F';'FF';'0F';'FF';'00';'00';...
...
% moving gripper requires not moving any other of the other joints
ms = [100 100 100 0];
md = [1 2 1 1 1];
command_test = getMotorCommand(ms, md);
...
% s.set('BytesAvailableFcnCount','50');
% s.set('BytesAvailableFcn','readMotorCommand');

while i<900
    
     if i<50
      fwrite(s,command_test)
      pause(0.05)
     end

     
     if 100<s.BytesAvailable
        data = fread(s,100,'uint8');
        data_f = flipud(data);
        idx = find(data==hex2dec('E7'),1);
        data_t = data(idx:idx+50);
